...
//                           <li>
//                             Almacenamiento de{" "}
//                             {producto.especificaciones.almacenamiento} para
//                             todos tus archivos
//                           </li>
//                           <li>
//                             Sistema de cámaras de{" "}
//                             {producto.especificaciones.camaraPrincipal} para
//                             fotos profesionales
//                           </li>
//                           <li>
...
const VerArticulo = () => {
  ...
  const toggleFavoritos = () => {
    const favoriteIds = JSON.parse(localStorage.getItem("favorites")) || [];
    if (favoriteIds.includes(producto.id)) {
      const updatedIds = favoriteIds.filter((favId) => favId !== producto.id);
      localStorage.setItem("favorites", JSON.stringify(updatedIds));
      setEnFavoritos(false);
      toast.info("Removido de favoritos");
    } else {
      favoriteIds.push(producto.id);
