...
export { default as logoLetrasF } from "./Logo-LetrasF.png";
export { default as LoginVideo } from "./LoginVideo.png";
export { default as VentaVideo } from "./VentaVideo.png";
export { default as CompraVideo } from "./CompraVideo.png";
