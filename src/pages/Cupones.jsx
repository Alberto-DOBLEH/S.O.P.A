// import React, { useState, useEffect, format } from "react";
// import Header from "../components/Heaader";
// import Footer from "../components/Footer";

// const Cupones = () => {
//   const [cupones, etCupones] = useState([]);

//   const generarCupon = () => {
//     const nuevoCupon = {
//       codigo: Math.random().toString(36).substring(2, 10).toUpperCase(),
//       descuento: Math.floor(Math.random() * 50) + 5,
...
//               <li key={index} className=" border py-4 rounded-lg shadow">
//                 <h3 className=" font-bold text-xl">{cupon.codigo}</h3>
//                 <p>Descuento: {cupon.descuento}</p>
//                 <p>
//                   Fecha de Vencimiento:{" "}
//                   {cupon.fechavencimiento.toLocaleDateString()}
//                 </p>
//               </li>
//             ))}
//           </ul>
//         )}
//       </div>
//       <button onClick={generarCupon} className="bg-blue-600 text-white">
//         Generar Cupon
//       </button>
